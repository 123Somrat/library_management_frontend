...
export default function Book({book}) {
  // console.log(Object.keys(book).join(","))
   ...
   const {_id,bookName,authorName,description,rating,imageUrl,quantity,category} = book
  return (
    <div>
...
<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-[670px]">
        ...
        <img className="p-8 rounded-t-lg h-[500px]" src={imageUrl} alt="product image"/>

    <div className="px-5 pb-5">
     
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{bookName}</h5>
